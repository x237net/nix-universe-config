# modules/home/firefox/extensions/flagfox.nix
# ===========================================
#
# Copying
# -------
...
with lib; let
  ...
  cfg = config.universe.home.firefox.extensions.flagfox;
  ...
  extProfiles = assertProfiles
    ...
    |> mergeAttrsList;
in {
  options.universe.home.firefox.extensions.flagfox = with types; mkOption {
    type = attrsOf (submodule {
      options = {
        enable = mkEnableOption ''
          Flagfox, an extension that displays a flag icon indicating the current
          webserver's physical location.
        '';
      };
    });
    default = {};
