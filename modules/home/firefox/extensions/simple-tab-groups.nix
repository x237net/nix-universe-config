# modules/home/firefox/extensions/simple-tab-groups.nix
# =====================================================
#
# Copying
# -------
...
with lib; let
  ...
  cfg = config.universe.home.firefox.extensions.simple-tab-groups;
  ...
  extProfiles = assertProfiles
    ...
    |> mergeAttrsList;
in {
  options.universe.home.firefox.extensions.simple-tab-groups = with types; mkOption {
    type = attrsOf (submodule {
      options = {
        enable = mkEnableOption ''
          Simple Tab Groups, manage Firefox tabs in groups.
        '';
      };
    });
    default = {};
