# modules/home/firefox/extensions/i-still-dont-care-about-cookies.nix
# ===================================================================
#
# Copying
# -------
...
with lib; let
  ...
  cfg = config.universe.home.firefox.extensions.i-still-dont-care-about-cookies;
  ...
  extProfiles = assertProfiles
    ...
    |> mergeAttrsList;
in {
  options.universe.home.firefox.extensions.i-still-dont-care-about-cookies = with types; mkOption {
    type = attrsOf (submodule {
      options = {
        enable = mkEnableOption ''
          I Still Don't Care About Cookies, removes cookie warnings from almost
          all websites.
        '';
      };
    });
