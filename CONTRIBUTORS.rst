...
The below stated terms was last updated on January 2nd, 2025.
...
The *universe/config* project is released under the licensing terms of the MIT
...
included within the *universe/config* project but does not fall under the terms
stated above.
...
The below-signed are contributors to the project named *universe/config*. Each
...
- Jimmy Thrasibule <dev@jimmy.lt>, 2025/01/02
